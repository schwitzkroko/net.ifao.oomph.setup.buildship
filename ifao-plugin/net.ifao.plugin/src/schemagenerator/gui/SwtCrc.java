   ...
   extends SwtBase
{
   ...
   private final static String IMPORT_DIR = "net/ifao/providerdata/crc";
   private final static String sPackage = "net.ifao.providerdata.crc";

   private Text textArea = null;

   private Text textAreaCorrections = null;

   public SwtCrc(Composite parent, int style)
   {
      super(parent, style);
      initialize();
   }
