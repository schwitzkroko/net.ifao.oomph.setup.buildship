...
public class SwtEhotel
   extends SwtBase
{

   private final static String IMPORT_DIR = "net/ifao/providerdata/ehotel";
   private final static String sPackage = "net.ifao.providerdata.ehotel";

   private Text textArea = null;

   private Text textAreaCorrections = null;

   public SwtEhotel(Composite parent, int style)
   {
      super(parent, style);
      initialize();
   }
